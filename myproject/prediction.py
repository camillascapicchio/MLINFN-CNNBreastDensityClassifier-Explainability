...
test_generator = test_datagen.flow_from_directory(
        '/arinas/Radioma_AOUP_fixed/camilla/dati_camilla/SEN_5354_muscleremoved/CC_R/test',  # this is the target directory, where the test set of images is.
...
model = load_model('/home/users/camilla/BIRADS_crop/Senograph53/18DICEMBRE2019/1/weights-improvement-51-0.80.h5')   #Insert the path to the model correspondent to the epoch that produced the best validation 															   accuracy improvement.
...
np.savetxt('/home/users/camilla/BIRADS_crop/Senograph53/18DICEMBRE2019/1/predictions_ccr.txt', classes)    #Save the results of prediction as a .txt file.
